...
{
    public function createBundle(Request $request, Bundle $bundle): View
    {
        return view('upload', [
    ...
    // The upload form
    public function storeBundle(Request $request, Bundle $bundle): JsonResponse
    {
        try {
            $bundle->update([
    ...
    public function uploadFile(Request $request, Bundle $bundle): JsonResponse
    {
    ...
    public function deleteFile(Request $request, Bundle $bundle): JsonResponse
    {
        $request->validate([
            'uuid'		=> 'required|uuid'
        ]);
    ...
    public function completeBundle(Request $request, Bundle $bundle): JsonResponse
    {
